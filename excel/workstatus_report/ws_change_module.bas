...
Dim testUrl As String 'this variable used because url can be changed while processing
...
Private Sub refreshIE()
    ...
    'Go to blank url then go to target url wait and exit
    ...
    'waiting time for more reliability
